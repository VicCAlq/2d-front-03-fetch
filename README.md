...
- `useState`: Referência de como se usa gestão de estados no React.
...
5. Se estiver na pasta correta, digite o comando `npm run dev` ainda no terminal para executar o projeto.
